  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center">Nous Contacter</h1>
        ...
        <div className="mt-12 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Informations de Contact</h2>
          <p className="text-lg text-gray-700 mb-2">Email: <a href="mailto:contact@chefathome.fr" className="text-orange-500 hover:underline">contact@chefathome.fr</a></p>
          <p className="text-lg text-gray-700">Téléphone: +33 1 23 45 67 89</p>
        </div>
      </div>
    </div>
  );
